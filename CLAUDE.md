...
- `TimeZoneModel.swift` — logic ported from the DC script: `utc` is a shared
  hour-of-day (0..<24, fractional for +5.5 offsets), dragging a city's dial
  picks that city's local hour and back-solves `utc`.
